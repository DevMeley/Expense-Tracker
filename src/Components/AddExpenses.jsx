...
function AddExpenses({closeAddCategoryModal}) {
  return (
    <div>
      <div className="bg-white p-4 flex flex-col gap-6 rounded-lg shadow-2xl absolute top-40 right-2 left-2 lg:w-92 lg:left-60">
